...
public:
    clsDevelopper(int Id ,string firstName,string lastName,string phone,string email ,float salary,string departement,string title,string  mainProgrammingLanguage) 
    :clsEmployee (Id , firstName, lastName, phone, email ,salary, departement, title)
    {
            ...
            void PrintInfo()
     {
       ...
       // clsPerson::PrintInfo() ;
        ...
        cout<<"The Email " <<getEmail() <<endl ;
            ...
            cout<<"The TItle "<<getTitle() <<endl ;
        cout<<"The Departement  " <<getDepartement() <<endl ;
        cout<<"The Salary " <<getSalary() <<endl ;
        cout<<"The Main programing language "<<_MainProgrammingLanguage  <<endl ;
...
int main() {
  ...
  srand((unsigned)time(NULL)); 
   ...
   //cin.ignore(1,'\n') ;
            ...
            clsDevelopper  Developper (10,"Nader","Chargui","+216 95 120 814","charguinadar@gmail.com",5000,"System administration","Managment Group","C++")  ;
