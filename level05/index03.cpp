...
int  CountNumberNegative(int arr[100] ,int length)
{
   int CountNumberNegative  = 0 ;

  for (int i = 0; i < length; i++)
       {
          if( arr[i]  < 0) CountNumberNegative++ ;
       }
...
int main() {
   ...
   cout<<"======================================================================\n";
   cout<<"===                CountNumberNegative using c++ languages            ====\n"                              ;
   cout<<"======================================================================\n";
...
cout<<"\n Even Number  Count is : "<<CountNumberNegative(arr,length) <<endl ;
