...
int GetDifferenceBetweenDatesWithNeagativeResult(StDate Date1 , StDate Date2 ,bool IncludeEnDay = false)
{
     int Days  = 0 ;
             short numberNegativeDay = 1 ;
     ...
     return IncludeEnDay ? ++Days  * (numberNegativeDay): Days * (numberNegativeDay) ;
}
   ...
   //cin.ignore(1,'\n') ;
           ...
           printf("\n  Diffrence Days Betweent Date1  and Date2 TotalDaysDifference = %d    Days ",TotalDaysDifference) ;
              ...
              cout<<"\n \n \n \n "  ;
                ...
                StDate  Date1Negative    = ReadFullDate()  ;
           StDate  Date2Negative   = ReadFullDate()  ;

                   int TotalDaysDifferenceNegativeDays  = GetDifferenceBetweenDatesWithNeagativeResult(Date1Negative,Date2Negative)  ;
             int TotalDaysDifferenceIncludeEndDayNegativeDays  = GetDifferenceBetweenDatesWithNeagativeResult(Date1Negative,Date2Negative,true)  ;

           printf("\n  Diffrence Days Betweent Date1  and Date2 TotalDaysDifference = %d    Days ",TotalDaysDifferenceNegativeDays) ;

               printf("\n \n Diffrence Days Betweent Date1  and Date2 (include End Day) TotalDaysDifference = %d Days ",TotalDaysDifferenceIncludeEndDayNegativeDays) ;
