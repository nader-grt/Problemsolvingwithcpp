...
int  CountNumberPositive(int arr[100] ,int length)
{
   int CountNumberPositive  = 0 ;

  for (int i = 0; i < length; i++)
       {
          if( arr[i]  > 0) CountNumberPositive++ ;
       }
...
int main() {
   ...
   cout<<"======================================================================\n";
   cout<<"===                CountNumberPositive using c++ languages            ====\n"                              ;
   cout<<"======================================================================\n";
...
cout<<"\n Even Number  Count is : "<<CountNumberPositive(arr,length) <<endl ;
